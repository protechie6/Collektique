...
class MyLibraryItemCarDetails extends StatelessWidget {
  
  const MyLibraryItemCarDetails({Key? key, required this.itemDetails}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    Widget vinNumber = Container(
      ...
      child: Text(
        "VIN Number: ${itemDetails.serialNumber}",
        style: const TextStyle(
            color: Color.fromRGBO(255, 255, 255, 1),
            fontFamily: 'Poppins',
            fontSize: 15,
    ...
    Widget bodyWorkOrAccident = Container(
      margin: const EdgeInsets.only(
        top: 10,
        left: 20,
      ),
      child: Text(
        "Any bodywork/Accidents: ${itemDetails.bodyWorkOrAccident}",
        style: const TextStyle(
            color: Color.fromRGBO(255, 255, 255, 1),
            fontFamily: 'Poppins',
            fontSize: 15,
    ...
    Widget ownedFor = Container(
      ...
      child: Text(
        "Number plate: ${itemDetails.numberPlate}",
        style: const TextStyle(
            color: Color.fromRGBO(255, 255, 255, 1),
            fontFamily: 'Poppins',
            fontSize: 15,
