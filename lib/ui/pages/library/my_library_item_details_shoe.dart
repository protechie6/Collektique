...
class MyLibraryItemDetailsShoe extends StatelessWidget {
  
  const MyLibraryItemDetailsShoe({Key? key, required this.itemDetails}) : super(key: key);
      ...
      child: Row(
        ...
        children: [
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => BoxAndPapers(boxAndPapers: itemDetails.serviceRecord, activity: 'Box and Papers',),),
            );
          },
          icon: const Icon(
            // <-- Icon
